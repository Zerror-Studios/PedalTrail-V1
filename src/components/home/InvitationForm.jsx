 ...
 * HOW TO FIND YOUR GOOGLE FORM'S entry.XXXXXXXXX IDs (one-time setup, ~2 min)
 * ============================================================================
 * (Instructions remain the same as your original code)
 */
...
const FIELD_IDS = {
  ...
  tagSocials: 'entry.REPLACE_ME_9',
  profession: 'entry.REPLACE_ME_10',
  sportingBackground: 'entry.REPLACE_ME_11',
  sportingBackgroundOther: 'entry.REPLACE_ME_11.other_option_response',
  playingSince: 'entry.REPLACE_ME_12',
  selfLevel: 'entry.REPLACE_ME_13',
};
...
export default function InvitationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    // HTML5 validation automatically triggers on the current step's rendered fields
    if (step < 3) {
      setStep((prev) => prev + 1);
      return;
    }
              ...
              <>
                  ...
                  <div className="flex gap-4">
                    {GENDER_OPTIONS.map((opt) => (
                      <label key={opt} className="flex items-center gap-1.5 text-sm text-gray-700 cursor-pointer">
                        <input
                          type="radio" name="gender" value={opt} required
                          checked={formData.gender === opt} onChange={handleChange}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <input
                      type="number" name="dobMonth" placeholder="MM" min="1" max="12" required
                      value={formData.dobMonth} onChange={handleChange}
                    ...
                    />
                    <input
                      type="number" name="dobDay" placeholder="DD" min="1" max="31" required
                      value={formData.dobDay} onChange={handleChange}
                      className="w-full bg-transparent border-b border-gray-300 pb-1.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-red-600 transition-colors"
                    />
                    <input
                      type="number" name="dobYear" placeholder="YYYY" min="1900" max="2100" required
                      value={formData.dobYear} onChange={handleChange}
                      className="w-full bg-transparent border-b border-gray-300 pb-1.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-red-600 transition-colors"
                    />
                  </div>
                </div>
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="tel" name="phone" placeholder="1 (555) 000-0000" required
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text" name="instagram" placeholder="@handle"
            ...
            {step === 3 && (
              <>
                <div>
                  ...
                  <input
                    type="text" name="profession" placeholder="e.g. Finance, Acme Corp, VP" required
                ...
                <div>
                  ...
                  <input
                    type="text" name="sportingBackgroundOther" placeholder="Other (optional)"
                    value={formData.sportingBackgroundOther} onChange={handleChange}
                    className="w-full bg-transparent border-b border-gray-300 pb-1.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-red-600 transition-colors"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      name="playingSince" value={formData.playingSince} onChange={handleChange} required
                      className="w-full bg-transparent border-b border-gray-300 pb-1.5 text-sm text-gray-800 focus:outline-none focus:border-red-600 transition-colors appearance-none cursor-pointer"
                    >
                      <option value="" disabled>Select duration</option>
                  ...
                  <div>
                    ...
                    <select
                      name="selfLevel" value={formData.selfLevel} onChange={handleChange} required
                      className="w-full bg-transparent border-b border-gray-300 pb-1.5 text-sm text-gray-800 focus:outline-none focus:border-red-600 transition-colors appearance-none cursor-pointer"
                    >
                      <option value="" disabled>Select level</option>
                ...
                <div className="flex items-start space-x-2 pt-1">
                  <input
                    type="checkbox" name="acceptedTerms" id="terms" required
